...
def stream_generate(model, tokenizer, input_ids, cache, max_tokens):
...
def run_demo(model_path, prompt, max_tokens, tq_bits=None):
...
def main():
    ...
    if args.compare:
        ...
        n1, s1, m1 = run_demo(args.model, args.prompt, args.max_tokens, tq_bits=None)
        mx.clear_cache()
        n2, s2, m2 = run_demo(args.model, args.prompt, args.max_tokens, tq_bits=3)
        ...
        run_demo(args.model, args.prompt, args.max_tokens, tq_bits=args.tq_bits)
